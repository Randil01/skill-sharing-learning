    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="hidden lg:block lg:w-7/12 relative">
        <div className='w-full h-full bg-gradient-to-br from-blue-400/80 via-purple-400/80 to-pink-400/80 relative'>
            ...
            <div className='absolute inset-0 flex flex-col items-center justify-center text-white p-12'>
                <h1 className='text-5xl font-bold mb-6 text-center'>Share Your Skills,<br/>Learn Together</h1>
                <p className='text-xl text-center opacity-90'>Join our community of learners and experts.<br/>Connect, collaborate, and grow together.</p>
      ...
      <div className="w-full lg:w-5/12 flex items-center justify-center h-full overflow-y-auto">
        <div className='w-full max-w-md px-8 py-8'>
            ...
            <h2 className='font-bold text-2xl mb-8'>Join Skill Plus Today</h2>
            ...
            <div className='space-y-6'>
                <div>
                    ...
                    <p className='text-sm mt-2 text-gray-500'>By signing up, you agree to the 
                        Terms of Service and Privacy Policy, including Cookie Use.</p>
                </div>
